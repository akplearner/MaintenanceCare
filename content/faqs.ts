...
export const faqs: Faq[] = [
  ...
  },
  {
    ...
    answer:
      'No, and we will not pretend otherwise. Those are licensed trades in Texas. What we do is identify the problem, photograph it, price it properly, and send a licensed partner contractor whose license and insurance we have verified — then manage access and stay on it until the job is finished and documented. You get one point of contact instead of four phone calls.',
  ...
  },
  {
    ...
    answer:
      'No. Plans are month to month and you can cancel with thirty days notice. Portfolio agreements are negotiated separately and usually run annually, because that pricing only works if the number of properties is stable.',
    contexts: ['plans'],
  },
  {
    id: 'insurance',
  ...
  },
  {
    ...
    answer:
      'A dated work order with the property address, every checklist area with its result, photographs of anything noted, and a plain-language summary of what needs attention and what does not. You can download a real anonymized one from the sample report page — no email address required.',
  ...
  },
  {
    ...
    answer:
      'Anything urgent gets a phone call within the hour, not an email you read on Monday. We photograph it, make it safe where we can, and tell you what it will take to fix and roughly what it will cost. If it needs a licensed trade, we have the partner contacted before you call us back.',
  ...
  },
  {
    ...
    answer:
      'By how many properties you manage, rather than by plan tier, because forty units do not all need visiting as often. We look at your actual mix — occupied, vacant, turning — and price the coverage against it. Start with the free three-property audit and we will quote from what we actually find.',
  ...
  },
  {
    ...
    answer:
      'We handle maintenance, inspections, repairs and exterior care for short-term rentals today, and we schedule around your booking calendar. Full turnover and make-ready coordination is not running yet — we would rather tell you that than take the booking and disappoint a guest.',
    contexts: ['str'],
  },
  {
    id: 'emergency',
    ...
    answer:
      'Not yet — a round-the-clock on-call rotation is something we will add later, and we will not promise it before we can keep it. Plan customers get priority response during business hours, and if we find something urgent during a visit we call you straight away.',
