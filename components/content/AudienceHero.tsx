    ...
    <section className="border-b bg-paper-raised">
      <Container>
        <div
          className={
            aside
              ? 'grid gap-10 pt-10 pb-10 lg:grid-cols-[1.1fr_1fr] lg:items-start lg:gap-12 lg:pt-16 lg:pb-14'
              : 'pt-10 pb-10 lg:pt-16 lg:pb-14'
          }
        >
          <div>
            <p className="text-sm font-semibold text-accent-ink">{eyebrow}</p>
